...
months=DateRange[{1979,1,1},{2017,10,1},"Month"];
(*
...
validation=Block[{select=30,day},
  day=Table[RandomSample[Range[Length[p[[i,1]]]],select],{i,-34,-1}];
...
SRNet=NetInitialize[NetGraph[<|"DynamicNet"->DynamicNet,
        ...
        "Dynamics"->{15,3,59,123},
        "Static"->{1,301,621}]]
SRNet=Import["/data/home/scy0446/run/Code/trained_Res.mx"];
